        ...
        <div class="card">
          ...
          <div class="card-content collapse show">
            <div class="card-body">
              ...
              <form class="form" method="post" action="{{ route('lawyers.store') }}">
                @csrf
                <div class="form-body">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" required  value="{{ old('name') }}" id="userinput1" class="form-control border-primary" placeholder="الاسم"
                        name="name">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="email" required value="{{ old('email') }}"  id="userinput2" class="form-control border-primary" placeholder="البريد الإلكتروني"
                        name="email">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" required  value="{{ old('membership_no') }}"  id="userinput11"  class="form-control border-primary" placeholder="رقم العضوية"
                        name="membership_no">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="category_id"  value="{{ old('category_id') }}" required class="form-control border-primary" id="">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="number" value="{{ old('phone') }}" required id="userinput3" class="form-control border-primary" placeholder="رقم الهاتف"
                        name="phone">
                      </div>
                    </div>
                    <div class="col-md-6">
