              ...
              <div class="card-body card-dashboard">
                ...
                <table class="table table-striped table-bordered zero-configuration">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{!! $servie->title !!}</td>
                      <td><img src="{{ asset('uploads/'.$servie->image) }}" width="100" height="70" alt=""></td>

                
                  
                      <td>
                        <a href="{{ route('frontservice.edit',$servie->id) }}" class="btn btn-icon btn-primary mr-1"> <i class="la la-edit"></i></a>
                        <form style="display: inline" action="{{ route('frontservice.destroy',$servie->id) }}" method="post">
                        @csrf @method('delete')
