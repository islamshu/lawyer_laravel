              ...
              <div class="card-body card-dashboard">
                ...
                <table class="table table-striped table-bordered zero-configuration">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $service->name }}</td>
                      <td><img src="{{ asset('uploads/'.$service->image) }}" width="80" height="50" alt=""></td>
                      <td>{{ $service->job_name }}</td>
                  
                      <td>
                        <a href="{{ route('team.edit',$service->id) }}" class="btn btn-icon btn-primary mr-1"> <i class="la la-edit"></i></a>
                        <form style="display: inline" action="{{ route('team.destroy',$service->id) }}" method="post">
                        @csrf @method('delete')
