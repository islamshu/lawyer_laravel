                ...
                <table class="table table-striped table-bordered zero-configuration">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('services.edit',$service->id) }}" class="btn btn-icon btn-primary mr-1"> <i class="la la-edit"></i></a>
                        <form style="display: inline" action="{{ route('services.destroy',$service->id) }}" method="post">
                        @csrf @method('delete')
